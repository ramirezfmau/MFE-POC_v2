...
export const SecondaryLayout = ({children }: LayoutProps) => (
  <div style={{display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh", justifyContent: "space-between"}}>
    <div style={{backgroundColor: "#14002C", width: "100%", textAlign: "center", padding: "20px"}}>Secondary Layout</div>

    <div style={{margin: "60px 0"}}>{children}</div>

    <footer style={{backgroundColor: "#14002C", width: "100%", textAlign: "center", padding: "20px"}}>
        Footer New Changes
    </footer>
  </div>
)
